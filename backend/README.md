...
## Project Structure
    ...
    ├── medication_calender_43511  # Django project configurations
...
1. Clone this repo and `cd medication_calender_43511`
...
2. Clone this repo and `cd medication_calender_43511`
